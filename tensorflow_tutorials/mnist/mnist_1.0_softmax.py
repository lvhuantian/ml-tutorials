...
# cross-entropy
# log takes the log fo each element, * multiplies tensors element by element
...
correct_prediction = tf.equal(tf.argmax(Y, 1), tf.argmax(Y_, 1))  # one-hot decoding
...
# to save animation as a movie, add save_movie=True as an argument to datavis.animate
