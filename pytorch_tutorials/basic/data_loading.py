...
# show an image and its landmarks and use it to show a sample
...
# Create a dataset class for our face landmarks dataset.
...
class Rescale(object):
    ...
    def __call__(self, sample):
        ...
        # h and w are swapped for landmarks because of images,
...
# put this all together to create a dataset with composed transforms.
